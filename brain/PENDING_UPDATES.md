...
Fila FIFO de lacunas que precisam ser confirmadas para manter o Brain fiel ao projeto.

## Pendencias

- [ ] Confirmar o nome do owner a ser usado no front-matter dos documentos canonicos. Valor inicial usado: `LuanTrindade95`.
- [ ] Detalhar a modelagem implementavel de `WorkflowDefinition`, `WorkflowStep`, `WorkflowTransition`, `StepApprover`, `WorkflowInstance`, `InstanceStep`, `InstanceStepDecision` e `WorkflowAction` na Fase 2.
